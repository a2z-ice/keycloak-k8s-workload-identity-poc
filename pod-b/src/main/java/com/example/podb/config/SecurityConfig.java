...
import com.example.podb.auth.PocJwtAuthenticationConverter;
...
public class SecurityConfig {
    ...
    private final PocJwtAuthenticationConverter jwtAuthenticationConverter;

    public SecurityConfig(PocJwtAuthenticationConverter jwtAuthenticationConverter) {
